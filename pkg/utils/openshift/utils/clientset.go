...
//func createTest(yamlStr string, _ *kieapp.Reconciler) (bool, error) {
//	r, err := GetClient()
//	if err != nil {
//		return false, err
//	}
...
//	}
//
//	yamlSample, err := shared.GetConsoleYAMLSample(&kieApp)
//	if err != nil {
//		return false, err
//	}
//	_, err = r.ConsoleYAMLSample.Create(yamlSample)
//	if err != nil {
//		return false, err
//	}
//	return true, nil
